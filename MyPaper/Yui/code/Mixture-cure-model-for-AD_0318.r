...
z2 = mixcure(Surv(diagnosis_age, event)~Gender+APOE,~Gender+APOE, data = AD.1,savedata=T)
print(z2)
...
my_gmm.2<-gmm(moments.G1,x=AD.3,t0=rep(0,3),type="iterative",
